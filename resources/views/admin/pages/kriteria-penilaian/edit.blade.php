...
@section('content-wrapper')
    <div class="container-fluid px-4">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ URL::to('kriteria-penilaian/' . $kriteriaPenilaian->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('aspek_penilaian') is-invalid @enderror" name="aspek_penilaian"
                            ...
                            @foreach ($aspekPenilaian as $item)
                                @if (old('aspek_penilaian', $kriteriaPenilaian->id_aspek_penilaian) == $item->id)
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('kode_kriteria_penilaian') is-invalid @enderror"
                            ...
                            value="{{ old('kode_kriteria_penilaian', $kriteriaPenilaian->kode_kriteria_penilaian) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nama_kriteria_penilaian') is-invalid @enderror"
                            ...
                            value="{{ old('nama_kriteria_penilaian', $kriteriaPenilaian->nama_kriteria_penilaian) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('bobot_kriteria_penilaian') is-invalid @enderror"
                            ...
                            value="{{ old('bobot_kriteria_penilaian', $kriteriaPenilaian->bobot_kriteria_penilaian) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('status_kriteria_penilaian') is-invalid @enderror"
                            ...
                            @foreach ($selectList as $item)
                                @if (old('status_kriteria_penilaian', $kriteriaPenilaian->status_kriteria_penilaian) == $item)
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number"
                            ...
                            value="{{ old('persentase_kriteria_penilaian', $kriteriaPenilaian->persentase_kriteria_penilaian) }}">
