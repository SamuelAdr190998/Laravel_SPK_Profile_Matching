...
@section('content-wrapper')
    <div class="container-fluid px-4">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ URL::to('aspek-penilaian') }}" method="POST">
                    @csrf
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('kode_aspek_penilaian') is-invalid @enderror"
                            name="kode_aspek_penilaian" id="kode_aspek_penilaian" value="{{ old('kode_aspek_penilaian') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nama_aspek_penilaian') is-invalid @enderror"
                            name="nama_aspek_penilaian" id="nama_aspek_penilaian" value="{{ old('nama_aspek_penilaian') }}">
