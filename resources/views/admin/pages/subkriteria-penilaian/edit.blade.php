...
@section('content-wrapper')
    <div class="container-fluid px-4">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ URL::to('subkriteria-penilaian/' . $subkriteriaPenilaian->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('kriteria_penilaian') is-invalid @enderror"
                            ...
                            @foreach ($kriteriaPenilaian as $item)
                                @if (old('kriteria_penilaian', $subkriteriaPenilaian->id_kriteria_penilaian) == $item->id)
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('kode_subkriteria_penilaian') is-invalid @enderror"
                            ...
                            value="{{ old('kode_subkriteria_penilaian', $subkriteriaPenilaian->kode_subkriteria_penilaian) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nama_subkriteria_penilaian') is-invalid @enderror"
                            ...
                            value="{{ old('nama_subkriteria_penilaian', $subkriteriaPenilaian->nama_subkriteria_penilaian) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number"
                            ...
                            value="{{ old('bobot_subkriteria_penilaian', $subkriteriaPenilaian->bobot_subkriteria_penilaian) }}">
